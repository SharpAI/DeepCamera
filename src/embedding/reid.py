...
class ReId:
    def __init__(self):
        ...
        loaded_lib = tvm.module.load('../../model/reid.tar')
        # json graph
        loaded_json = open("../../model/reid").read()
        # parameters in binary
        loaded_params = bytearray(open("../../model/reid.params", "rb").read())
    ...
    def get_embeding(self, file_name):
        start = time.time()
        data = transform_image(Image.open(file_name).resize((128, 384)))
