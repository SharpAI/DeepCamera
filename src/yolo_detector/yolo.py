...
class Yolo():
    def __init__(self):
        ...
        self.net = self.darknet_lib.load_network("../../model/yolo/yolo.cfg", ffi.NULL, 0)

        lib = tvm.module.load('../../model/yolo/yolo.tar')
        graph = open("../../model/yolo/yolo").read()
        params = bytearray(open("../../model/yolo/yolo.params", "rb").read())
