...
a = Analysis(['../src/face_detection/worker.py'],
             ...
             'celery.concurrency.solo','celery.concurrency.asynpool', 'celery.worker.components', 'celery.worker.autoscale',
             ...
             'packaging.version', 'packaging.specifiers', 'packaging.requirements', 'packaging.markers', 'email',
             'email.message', 'email.mime.message', 'email.mime.image', 'email.mime.text',
             'email.mime.audio', 'email.mime.base', 'email.mime.multipart', 'email.mime.nonmultipart','kombu.connection'],
             hookspath=[],
             runtime_hooks=[],
